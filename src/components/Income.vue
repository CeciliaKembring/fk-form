      ...
      <form action="#">
            <div class="container">
                  ...
                  <div v-if="isFilledIn" class="other">
                        <p>Fyll i vilka inkomster du tror att du kommer att ha i år och nästa år. Om du får högre eller
                              lägre
                        ...
                        <div v-if="incomeSelection === 'yes_income' && isFilledIn" class="have_income">
                              ...
                              <label for="other_income">Jag har inkomst eller pension från ett annat land som inte
                                    beskattas i
                                    Sverige eller som beskattas enligt SINK.</label>
                              <div class="travel_info">
                                    <p class="bold">Inkomster före skatt – uppskattat belopp för hela året i landets
                                          valuta
                                    </p>
                                    <div class="input_form">
                        ...
                        <p>Det är till exempel ränta på pengar på banken, utdelning, kapitalvinst vid försäljning av
                              aktier
                              eller en
